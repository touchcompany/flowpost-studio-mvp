...
function mergeScopedRecords(currentState, incomingState, session) {
  ...
  return {
    ...
    financeTransactions: replaceScoped(currentState.financeTransactions || [], incomingState.financeTransactions || []),
    monthlyProviders: replaceScoped(currentState.monthlyProviders || [], incomingState.monthlyProviders || []),
...
function aiPromptForScript(payload = {}) {
  ...
  return [
    ...
    `Fuentes y referencias del usuario: ${publication.referenceNotes || "sin referencias"}.`,
    `Criterios de aprobacion del cliente: ${publication.approvalCriteria || "sin criterios especificos"}.`,
    ...
    "Respeta las fuentes, referencias y criterios de aprobacion. Si algo no esta probado, plantealo como idea revisable y no como afirmacion absoluta.",
