-- Flowpost Studio: migraciones pendientes para produccion.
-- Ejecutar una vez en Supabase SQL Editor si /api/supabase/check muestra schema.ok=false.

-- 1. Papelera y recuperacion por 30 dias para empresas y usuarios.
...
-- 2. Roles, accesos por empresa y metadatos de usuario.
...
-- 3. Biblioteca de prompts por empresa para guiones, imagenes y videos.
...
-- 4. Operacion de agencia: servicios, compras, facturas, actividad y borradores.
